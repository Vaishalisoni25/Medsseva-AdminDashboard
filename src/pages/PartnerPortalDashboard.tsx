...
export const PartnerPortalDashboardPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-emerald-500/20">
      {/* Top Navbar */}
      <header className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800 sticky top-0 z-40 px-4 sm:px-6 py-3 sm:py-4 flex flex-wrap items-center justify-between gap-3 shadow-lg">
        <div className="flex items-center gap-2.5 sm:gap-3">
          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-emerald-400 font-bold shadow-inner shrink-0">
          ...
          <div>
            <div className="font-extrabold text-white text-sm sm:text-base tracking-tight flex items-center gap-2">
              MedsSeva <span className="text-emerald-400 text-[10px] sm:text-xs px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 font-bold">Tie-up Partner</span>
            </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
        {/* Welcome & Badges Bar */}
        <div className="bg-gradient-to-r from-emerald-950/80 via-slate-900/90 to-slate-900/80 border border-emerald-500/30 rounded-2xl p-4 sm:p-6 shadow-xl relative overflow-hidden flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-1 z-10">
            <div className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-emerald-400">Tie-up Diagnostic Partner</div>
            <h1 className="text-xl sm:text-2xl font-black text-white">{data?.partner?.labName || 'Diagnostic Partner Lab'}</h1>
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 z-10">
            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-3 sm:px-4 py-2 text-center flex-1 sm:flex-none">
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div className="flex flex-wrap items-center gap-1 bg-slate-900 border border-slate-800 p-1 rounded-xl w-full sm:w-auto">
              {[
